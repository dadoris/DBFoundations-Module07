...
# Module 07: Functions
## Introduction
This week’s topic is Functions including scalar, table, and user defined functions (UDF).  In addition to posting to the GitHub repository as I did for module 06, I've  createe this GitHub webpage for review.  This week's questions are: 
